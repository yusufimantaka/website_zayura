        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          <div className="col-span-1 md:col-span-1">
            ...
            <div className="flex gap-4">
              <Link href="#" className="p-2 bg-gray-50 rounded-full text-gray-400 hover:text-primary transition-colors">
                <Instagram size={20} />
              </Link>
              <Link href="#" className="p-2 bg-gray-50 rounded-full text-gray-400 hover:text-primary transition-colors">
                <Mail size={20} />
          ...
          <div>
            <h4 className="font-extrabold text-gray-900 mb-6 tracking-tight">Navigasi</h4>
          ...
          <div>
            <h4 className="font-extrabold text-gray-900 mb-6 tracking-tight">Tipe Kamar</h4>
            <ul className="space-y-4 text-sm text-gray-500 font-medium">
          ...
          <div>
            <h4 className="font-extrabold text-gray-900 mb-6 tracking-tight">Hubungi Kami</h4>
            <ul className="space-y-4 text-sm text-gray-500 font-medium">
